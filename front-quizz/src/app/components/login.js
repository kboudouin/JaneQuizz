        ...
        <div className="w-full p-6 m-auto rounded-md lg:max-w-lg">
            ...
            <form className="space-y-4" onSubmit={handleLogin}>
                <div>
                    ...
                    <input autoComplete="on" value={username} onChange={e => setUsername(e.target.value)}  type="text" placeholder="Enter Username" className="w-full input input-bordered input-primary" />
                </div>
                <div>
                    <label className="label">
                        <span className="text-base label-text">Password</span>
                    </label>
                    <input autoComplete="on"  value={password} onChange={e => setPassword(e.target.value)} type="password" placeholder="Enter Password"
